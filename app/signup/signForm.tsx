...
const SignForm = (props: Props) => {
  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen py-2'>
       ...
       <input type="text" className='p-1 border-gray-300 border-[1px] rounded-lg w-[300px] mb-4 focus:outline-none focus:border-gray-600 text-black' id='name' value={user.name} placeholder='name' onChange={(e) => setUser({...user, name:e.target.value})} />
       ...
       <button onClick={Register} className='p-2 border bg-purple-600 text-white border-gray-300 mt-2 mb-4 focus:outline-none focus:border-gray-600 text-black'>Register Now</button>
