...
const Info:React.FC<Props> = ({title,description,id,price,color,size,userId,store}) => {
        ...
        <div className='relative info'>
            ...
            <ul className='flex space-x-5'>
                {sizes.map((size,index) => (
                    <li
                    key={index}
                    className={`p-1 px-2 border-[1px] rounded-lg cursor-pointer inline-block text-center ${selectSizes.includes(size) ? "bg-black text-white" : "bg-white text-black"} `}
