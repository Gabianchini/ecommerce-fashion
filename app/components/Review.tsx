...
const Review = ({productId,userId}: Props) => {
    ...
    return (
        <div>
            <h1 className="text-xl font-medium mb-4">Give your review </h1>
            <h2 className="mb-2">
                Give Rating
            </h2>
            <ReactStars onChange={onChange} value={defaultReviewForm.star} size={17} isEdit={true} activeColors={['red','orange', "#FFCE00", "#9177FF", "#8568FC"]}/>
            <h2 className="mt-4">Write your comment here</h2>
            <div>
