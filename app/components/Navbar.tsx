        ...
        <div>
            <div className="flex items-center justify-between py-4 relative">
                <div className="flex items-center md:space-x-10 lg:space-x-20">
                    <div className="font-semibold text-2xl"><a href="/">TrendVogue</a> </div>
           ...
           <div className={`md:hidden ${showNav ? "pb-4 px-5" : "h-0 invisible opacity-0"}`}>
                    <ul className="flex flex-col text-[15px] opacity-75 px-2">
                        ...
                        <li><a href="/filters" className="py-3 inline-block w-full">Filters</a></li>
                        <li><a href="/myproducts" className="py-3 inline-block w-full">Shop</a></li>
                    </ul>
                    ...
                    <button><BiSearch size={20} className='flex opacity-50'/></button>
                    </div>
            </div>
        </div>
    )
